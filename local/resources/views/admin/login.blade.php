			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="../images/cgroup-backend.png" width="85px" height="60px" alt="Klorofil Logo"></div>
								<p class="lead">Login to your account</p>
                            </div>
                            @include('errors.note')
							<form class="form-auth-small" method="post" action="{{asset('login')}}" enctype="multipart/form-data">
